...
- 改动涉及两个子任务，写简版清单到 `AIRunWorkDocs/runtime/subtasks.json`：

| 序号 | 需求项 | 数据来源 |
|------|--------|---------|
| M1 | 邮件列表顶部小红条 | CGI 字段 is_show_warning_icon_in_mailtab |
| M2 | 点击小红条跳转管理页 | TAPD 原文 |
...
3. 输出现场快报：接下来新增 M3"小红条支持两种状态"，下一步：代码定位。
4. 从代码定位开始继续推进。
