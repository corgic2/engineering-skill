#!/usr/bin/env python3
"""
init_engineering_project.py - 为项目初始化 engineeringworkflow-nosdd 工程骨架。
用法：
...
def init_project(project_root: Path, modules: list[str], root_dir_name: str = "AIRunWorkDocs", language: str = "cpp"):
    ...
    print(f"[init_engineering_project] Initialized engineeringworkflow-nosdd at {workflow_root}")
